...
A high-fidelity mockup showing the EcoTrace AI Dashboard layout has been generated in the project files as:
* **Dashboard Interface Screenshot**: `ecotrace_dashboard.png`

The mockup shows the carbon footprint score card rendering an eco score of 5.8 Tons CO2e/Year, a breakdown doughnut chart, and a line chart of historical progress.

---

## 5. Open Source Code Link
To set up and run this codebase locally or upload it to GitHub:
1. Initialize a Git repository in this folder:
   ```bash
   git init
   git add .
   git commit -m "Initial commit - EcoTrace AI Capstone"
   ```
2. Create a repository on GitHub named `ecotrace-ai-sdg13`.
3. Link and push the code:
   ```bash
   git remote add origin https://github.com/YOUR_USERNAME/ecotrace-ai-sdg13.git
   git branch -M main
   git push -u origin main
   ```
*(Replace `YOUR_USERNAME` with your actual GitHub username to complete the link)*
...
## 7. How to Run
Since the project is built in Vanilla JS, it has **zero dependencies** and requires no compilation.

### Option A: Direct Launch (No setup)
Double-click `index.html` to open the app directly in any web browser.

### Option B: Local Web Server (Recommended)
Running through a local web server ensures assets load cleanly.
